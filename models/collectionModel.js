...
mongoose.model("collection", collectionSchema).find({ collectionType: "DEFAULT" }, (err, result) => {
    if (err) {
        ...
        mongoose.model("collection", collectionSchema).create(obj, (err1, staticResult) => {
            if (err1) {
